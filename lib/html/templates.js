    ...
    <div style="font-family: Arial, Helvetica, sans-serif">
      ...
      <div style="display: flex; justify-content: center; width: 100%">
        <button  style="background-color: #4caf50;
          ...
          color: white;
        ">
          <a style="color: white" href="http://10.0.0.2:5000/auth/login_email_verification?token=${token}">Ověřit email</a>
        </button>
      </div>
    ...
    <div style="font-family: Arial, Helvetica, sans-serif">
      ...
      <div style="display: flex; justify-content: center; width: 100%">
        <button  style="background-color: #4caf50;
          ...
          color: white;
        ">
          <a style="color: white" href="http://10.0.0.2:5000/auth/create_group_email_verification?token=${token}">Ověřit email</a>
        </button>
      </div>
      <p id="verified" style="font-size: 18px; color: green"></p>
    </div>
